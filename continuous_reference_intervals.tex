...
\(\lambda\). Setting a \(\lambda\) smoothing term of zero shows
...
\texttt{lambda\ =\ lseq(0.01,30,l=20)}, which is a logarithmic sequence
of numbers from 0.01 to 30 of length 20 (0.01, 0.014, 0.0.19, \ldots,
21.49, 30). By feeding \texttt{ps()} this sequence of numbers, the
